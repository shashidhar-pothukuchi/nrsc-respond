...
<?php
include('db.php');
$result = $conn->prepare("SELECT * FROM copi where id='$ID'");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){
$id=$row['id'];
?>
<form class="form-horizontal" method="post" action="edit_COPIO.php<?php echo '?id='.$id; ?>"  enctype="multipart/form-data" style="float: right;">
                                ...
                                <div class="control-group">
								 ...
								 <div class="control-group">
                                    <div class="controls">
										...
										<a href="copiindex.php" class="btn">Back</a>
                                    </div>
                                </div>
                            </form>
<?php } ?>
