...
<?php
include('db.php');
$result = $conn->prepare("SELECT * FROM university where student_id='$ID'");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){
$id=$row['student_id'];
?>
<form class="form-horizontal" method="post" action="edit_PDOu.php<?php echo '?student_id='.$id; ?>"  enctype="multipart/form-data" style="float: right;">
								...
								<div class="control-group">
								 ...
								 <div class="control-group">
                                    <div class="controls">
										...
										<a href="index2.php" class="btn">Back</a>
                                    </div>
                                </div>
