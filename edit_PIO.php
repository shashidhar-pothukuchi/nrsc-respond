...
$sql = "UPDATE pi SET institute_name ='$institute_name', department ='$department', location ='$location', 
...
$conn->exec($sql);
echo "<script>alert('Successfully Edit The Account!'); window.location='piindex.php'</script>";
