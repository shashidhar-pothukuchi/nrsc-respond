...
<?php include('modal_add.php'); ?>
                        ...
                        <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                            <div class="alert alert-info">
                                ...
                                <strong><i class="icon-user icon-large"></i>&nbsp;College Information Table</strong>                            </div>
                            <thead>
                                <tr>
                                  <th colspan="6" style="text-align:center;">COLLEGE DETAILS </th>
                                </tr>
                                <tr>
							...
							?>
								...
								<a href="delete.php<?php echo '?student_id='.$id; ?>" class="btn btn-danger">Yes</a>								</div>
								</div>
								</div>
								</tr>
								<?php } ?>
